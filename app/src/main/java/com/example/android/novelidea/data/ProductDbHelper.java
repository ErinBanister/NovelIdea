...
public class ProductDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String SQL_CREATE_PRODUCTS_TABLE = "CREATE TABLE " + ProductsEntry.TABLE_NAME + " ("
                ...
                + ProductsEntry.COLUMN_TITLE + " TEXT NOT NULL, "
                + ProductsEntry.COLUMN_AUTHOR + " INTEGER NOT NULL, "
                + ProductsEntry.COLUMN_PRICE + " INTEGER NOT NULL DEFAULT 0, "
                + ProductsEntry.COLUMN_GENRE + " INTEGER NOT NULL, "
                + ProductsEntry.COLUMN_QTY + " INTEGER NOT NULL DEFAULT 0, "
